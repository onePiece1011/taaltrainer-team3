<?php
    ...
    if (isset($_GET['reset']) && $_GET['reset'] === 'true') {
        ...
        header('Location: turkszinnenleren.php');
        exit();
    }

    if (!isset($_SESSION['turks_questions']) || !isset($_SESSION['turks_question_index'])) {
        $result = $conn->query("SELECT turkish_word, dutch_word FROM vocabulary WHERE turkish_word IS NOT NULL AND dutch_word IS NOT NULL AND category = 'Zinnen'");
        $all = [];
